...
Les travaux pratiques suivront la structure du site LeetCode.

Selon la progression dans le cours, voici les attentes par rapport au code:
...
Pour chaque TP, la note est calculée en fonction du nombre d'exercices réalisés, leur difficulté et l'explication en classe.
...
Pour chaque problème résolu, une question peut être posée sur chaque ligne de code.

Pour les problèmes plus complexes (3 et plus), une question supplémentaire est posée en classe.
...
Pour chaque exercice, une note est donnée sur 100, en fonction des critères énoncés.

La note est multiplié ensuite par le seuil atteint.

Une fois l'évaluation en classe faite, elle multiplie aussi le résultat.

Exemple: Une personne étudiante fait 17 points d'exercices, obtient 95% sur son code.
Elle explique de manière décente, mais quelques détails sont manqués:
...
Les examens seront de format mixte: 

Une partie sera théorique, format papier, pour 50% de l'examen.

Pour la deuxième partie, il faudra compléter un code avec de nonuvelles fonctionnalités.

L'examen 1 sera évalué avec les critères de code du TP1, le deuxième avec ceux du TP2.
